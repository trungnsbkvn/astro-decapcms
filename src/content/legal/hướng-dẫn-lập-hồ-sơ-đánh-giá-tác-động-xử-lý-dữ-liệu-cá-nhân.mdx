...
Bên kiểm soát dữ liệu cá nhân là tổ chức, cá nhân có quyền quyết định mục đích và phương pháp xử lý dữ liệu cá nhân. Chủ thể này có vai trò chính là quyết định thu thập, sử dụng và lưu trữ dữ liệu cá nhân; chịu trách nhiệm chính trong việc đảm bảo dữ liệu cá nhân được xử lý tuân thủ quy định của pháp luật và thực hiện các biện pháp bảo vệ dữ liệu, bao gồm xây dựng chính sách, thông báo minh bạch cho chủ thể dữ liệu.

**Ví dụ:** Một công ty thương mại điện tử thu thập thông tin khách hàng để thực hiện mua bán trực tuyến, chẳng hạn như sàn Shopee hoặc Tiktok đang rất trending hiện nay thì công ty này được xác định là bên kiểm soát dữ liệu cá nhân. 

### 1.2. Bên kiểm soát và xử lý dữ liệu cá nhân là gì?

Bên kiểm soát và xử lý dữ liệu cá nhân là tổ chức, cá nhân vừa thực hiện chức năng kiểm soát đồng thời cũng trực tiếp tham gia xử lý dữ liệu cá nhân.
...
Để được xác định là Bên xử lý dữ liệu cá nhân thì tổ chức/cá nhân phải đáp ứng đủ hai điều kiện sau:

(i) Là bên trực tiếp xử lý dữ liệu cá nhân; 

(ii) Việc xử lý dữ liệu cá nhân phải được thực hiện trên cơ sở một Hợp đồng hoặc thoả thuận với Bên kiểm soát dữ liệu cá nhân theo các mục đích và phương tiện xử lý DLCN mà Bên kiểm soát DLCN chỉ định;
...
**Ví dụ:** Công ty A có nhu cầu sử dụng dịch vụ tính lương, thưởng, các chế độ cho người lao động của Công ty nên Công ty A đã ký hợp đồng với Công ty B. Theo Hợp đồng, Công ty A sẽ cung cấp dữ liệu cá nhân của người lao động của Công ty A cho Công ty B để Công ty B tính lương cho người lao động của Công ty A. 

Xét trong mối quan hệ giữa Công ty A và Công ty B: Công ty B là Bên được cung cấp dữ liệu cá nhân và trực tiếp xử lý dữ liệu cá nhân (phân tích, lưu trữ, giải mã, …) để tính lương, thưởng, chế độ cho người lao động của Công ty A trên cơ sở Hợp động với Công ty A cho nên Công ty B được xác định là Bên xử lý dữ liệu cá nhân.
...
Hiện nay, Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân có thể được nộp qua ba hình thức bao gồm: trực tiếp, trực tuyến, và dịch vụ bưu chính. 

\- Hình thức trực tiếp: Tổ chức hoặc cá nhân nộp hồ sơ tại Cục An ninh mạng và Phòng, chống tội phạm sử dụng công nghệ cao thuộc Bộ Công an

\- Hình thức nộp trực tuyến: Hồ sơ được nộp qua Cổng thông tin quốc gia về bảo vệ dữ liệu cá nhân (theo thông báo của Bộ Công an).

\- Hình thức nộp qua dịch vụ bưu chính: Tổ chức hoặc cá nhân nộp hồ sơ qua bưu điện hoặc chuyển phát nhanh có báo phát gửi đến Cục An ninh mạng và Phòng, chống tội phạm sử dụng công nghệ cao thuộc Bộ Công an

Sau khi nhận được hồ sơ, Cục An ninh mạng và phòng, chống tội phạm sử dụng công nghệ cao thuộc Bộ Công an sẽ đánh giá, yêu cầu Bên Kiểm soát dữ liệu cá nhân, Bên Kiểm soát và xử lý dữ liệu cá nhân, Bên Xử lý dữ liệu cá nhân hoàn thiện Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân trong trường hợp hồ sơ chưa đầy đủ và đúng quy định.
