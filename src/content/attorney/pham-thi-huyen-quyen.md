...
name_en: "Pham Thi Huyen Quyen"
name_zh: "Pham Thi Huyen Quyen (范氏玄娟)"
name_ja: "Pham Thi Huyen Quyen (ファム・ティ・フエン・クエン)"
name_ko: "Pham Thi Huyen Quyen"
position: "Luật sư thành viên"
credentials:
  - "Luật sư"
bio: |
  Với nhiều năm kinh nghiệm trong lĩnh vực tư vấn Doanh nghiệp và pháp chế nội bộ, Luật sư Phạm Thị Huyền Quyên đã trở thành một đối tác tin cậy của nhiều Doanh nghiệp.
  
  Bà giúp Doanh nghiệp xây dựng và triển khai các chiến lược phát triển bền vững, đảm bảo tuân thủ các quy định pháp lý trong suốt quá trình hoạt động.
shortBio: "Nhiều năm kinh nghiệm tư vấn Doanh nghiệp và pháp chế nội bộ"
shortBio_en: "Extensive experience in Corporate Advisory and In-house Counsel"
shortBio_zh: "多年企业咨询和内部法律顾问经验"
shortBio_ja: "多年の企業アドバイザリーおよびインハウスカウンセル経験"
shortBio_ko: "다년간의 기업 자문 및 사내 법무 경험"
bio_en: |
  With extensive experience in Corporate Advisory and In-house Legal Counsel, Attorney Phạm Thị Huyền Quyên has become a trusted partner of many enterprises.
  
  She helps businesses develop and implement sustainable growth strategies while ensuring compliance with legal regulations throughout their operations.
bio_zh: |
  凭借多年的企业咨询和内部法律顾问经验，范氏玄琴律师已成为众多企业的值得信赖的合作伙伴。
  
  她帮助企业制定和实施可持续发展战略，确保在整个运营过程中符合法律法规。
bio_ja: |
  企業アドバイザリーおよびインハウスリーガルカウンセルとして多年の経験を持つファム・ティ・フエン・クエン弁護士は、多くの企業の信頼できるパートナーとなっています。
  
  彼女は企業が持続可能な成長戦略を策定・実施し、事業運営全体を通じて法的規制を確実に遵守するよう支援しています。
bio_ko: |
