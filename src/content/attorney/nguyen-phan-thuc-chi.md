...
name_en: "Nguyen Phan Thuc Chi"
name_zh: "Nguyen Phan Thuc Chi (阮潘淑芝)"
name_ja: "Nguyen Phan Thuc Chi (グエン・ファン・トゥック・チー)"
name_ko: "Nguyen Phan Thuc Chi"
position: "Chuyên viên pháp lý"
credentials:
  - "Cử nhân Luật"
bio: |
  Nguyễn Phan Thục Chi là Chuyên viên pháp lý tại Công ty Luật TNHH Youth & Partners (Y&P Law Firm), chuyên về các lĩnh vực Doanh nghiệp và Đầu tư nước ngoài.
  
  Với kinh nghiệm làm việc tại các công ty FDI, cô hỗ trợ tư vấn pháp luật thường xuyên cho Doanh nghiệp, rà soát hợp đồng và xử lý các thủ tục liên quan đến giấy phép đầu tư có vốn đầu tư nước ngoài.
bio_en: |
  Nguyễn Phan Thục Chi is a Legal Specialist at Youth & Partners Law Firm (Y&P Law Firm), specializing in Corporate Law and Foreign Investment.
  
  With experience working at FDI companies, she provides regular legal advice to enterprises, reviews contracts, and handles procedures related to foreign investment certificates.
bio_zh: |
  阮潘淑志是Youth & Partners律师事务所（Y&P律师事务所）的法律专员，专门从事企业法和外国投资。
  
  凭借在外商直接投资公司工作的经验，她为企业提供定期法律咨询，审查合同并处理与外国投资证书相关的程序。
bio_ja: |
  グエン・ファン・トゥック・チは、Youth & Partners法律事務所（Y&P法律事務所）の法務スペシャリストで、企業法と海外投資を専門としています。
  
  FDI企業での勤務経験を持ち、企業への定期的な法的アドバイスの提供、契約審査、海外投資証明書に関連する手続きの処理を行っています。
bio_ko: |
  응웬판툭치는 Youth & Partners 법률 회사(Y&P 법률 회사)의 법무 전문가로, 기업법 및 외국인 투자를 전문으로 합니다.
  
  FDI 기업에서의 근무 경험을 바탕으로, 기업에 정기적인 법률 자문을 제공하고, 계약을 검토하며, 외국인 투자 인증서 관련 절차를 처리합니다.
shortBio: "Chuyên viên pháp lý, chuyên về Doanh nghiệp, Đầu tư FDI"
shortBio_en: "Legal Specialist in Corporate Law and FDI Investment"
...
education:
  - degree: "Cử nhân Luật"
    ...
    degree_ja: "法学士"
    degree_ko: "법학사"
    institution: "Đại học Luật Hà Nội - Luật Kinh tế"
    institution_en: "Hanoi Law University - Economic Law"
    institution_zh: "河内法律大学 - 经济法"
    institution_ja: "ハノイ法科大学 - 経済法"
    institution_ko: "하노이 법과대학 - 경제법"
    year: 2024
specializations:
  - "Doanh nghiệp"
  - "Lao động"
