...
name_en: "Nguyen Phung Mai Anh"
name_zh: "Nguyen Phung Mai Anh (阮冯梅英)"
name_ja: "Nguyen Phung Mai Anh (グエン・フン・マイ・アイン)"
name_ko: "Nguyen Phung Mai Anh"
position: "Chuyên viên pháp lý"
credentials:
  - "Cử nhân Luật"
bio: |
  Nguyễn Phùng Mai Ánh là Chuyên viên pháp lý tại Công ty Luật TNHH Youth & Partners (Y&P Law Firm), đảm nhiệm vai trò biên tập viên chuyên về lĩnh vực Dân sự và Hành chính.
  
  Các bài viết của Mai Ánh tập trung phân tích, tổng hợp và làm rõ các quy định pháp luật, chính sách nổi bật liên quan đến quyền sử dụng đất, hợp đồng, hôn nhân gia đình và các vấn đề pháp lý Dân sự.
bio_en: |
  Nguyễn Phùng Mai Ánh is a Legal Specialist at Youth & Partners Law Firm (Y&P Law Firm), serving as an editor specializing in Civil Law and Administrative Law.
  
  Mai Ánh's articles focus on analyzing, synthesizing, and clarifying legal regulations and prominent policies related to land use rights, contracts, marriage and family, and civil legal issues.
bio_zh: |
  阮凤梅映是Youth & Partners律师事务所（Y&P律师事务所）的法律专员，担任编辑，专门从事民事法和行政法。
  
  梅映的文章主要分析、综合和阐明与土地使用权、合同、婚姻家庭以及民事法律问题相关的法律法规和重要政策。
bio_ja: |
  グエン・フン・マイ・アインは、Youth & Partners法律事務所（Y&P法律事務所）の法務スペシャリストで、民事法と行政法を専門とする編集者を務めています。
  
  マイ・アインの記事は、土地使用権、契約、婚姻家族、民事法的問題に関連する法的規制や重要な政策を分析、統合、明確化することに焦点を当てています。
bio_ko: |
  응웬풍마이안은 Youth & Partners 법률 회사(Y&P 법률 회사)의 법무 전문가로, 민사법 및 행정법을 전문으로 하는 편집자 역할을 맡고 있습니다.
  
  마이안의 기사는 토지 사용권, 계약, 결혼 및 가족, 민사 법률 문제와 관련된 법률 규정 및 주요 정책을 분석, 종합 및 명확히 하는 데 중점을 둡니다.
shortBio: "Chuyên viên pháp lý - Biên tập viên, chuyên về Dân sự, Đất đai"
shortBio_en: "Legal Specialist - Editor, specializing in Civil Law, Land Law"
...
education:
  - degree: "Cử nhân Luật"
    ...
    degree_ja: "法学士"
    degree_ko: "법학사"
    institution: "Khoa Luật, Học viện Hành chính Quốc Gia"
    institution_en: "Faculty of Law, National Academy of Public Administration"
    institution_zh: "法学院，国家行政学院"
    institution_ja: "法学部、国家行政学院"
    institution_ko: "법학부, 국가행정학원"
    year: 2024
specializations:
  - "Dân sự"
  - "Đất đai"
