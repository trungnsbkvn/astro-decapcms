...
import { cleanSlug, trimSlash, BLOG_BASE, POST_PERMALINK_PATTERN, CATEGORY_BASE, TAG_BASE } from './legal-permalinks';
...
/** */
export const findLatestLegalPosts = async ({ count }: { count?: number }): Promise<Array<Post>> => {
